...
class RunRecord(TimestampMixin, Base):
    ...
    codex_active_turn_id: Mapped[str | None] = mapped_column(String(255))
    codex_session_key: Mapped[str | None] = mapped_column(String(255))
    codex_state: Mapped[str | None] = mapped_column(String(64))
    codex_pending_request_id: Mapped[str | None] = mapped_column(String(255))
    codex_last_event_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
